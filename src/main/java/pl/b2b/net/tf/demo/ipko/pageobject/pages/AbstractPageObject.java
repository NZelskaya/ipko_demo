...
public abstract class AbstractPageObject {
    ...
    private static String logoCss = "#header .logo";

//    @FindBy(css = ".ui-loader-container")
//    protected WebElement ajaxLoaderContainer;

    protected By ajaxLoaderBy() {
        return By.xpath("//*[@class='ui-ajax-loader']");
    }
    ...
    protected void waitForAjax() {
        wait.until(ExpectedConditions.invisibilityOfElementLocated(ajaxLoaderBy()));
    }
