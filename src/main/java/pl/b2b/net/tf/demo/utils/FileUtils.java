...
public class FileUtils {
    ...
    private static void delete(Path path) {
        try {
            ...
            System.out.println("Something went wrong during file deletion. Execution would be continued ignoring exception :" + Arrays.toString(e.getStackTrace()));
        }
    }
    ...
    static String getStringFromInputStream(InputStream is, int LineNumber) {
        ...
        try {
            ...
            System.out.println("Something went wrong during reading file" + Arrays.toString(e.getStackTrace()));
        } finally {
            if (br != null) {
                try {
                    br.close();
                } catch (IOException e) {
                    System.out.println("Something went wrong during closing file" + Arrays.toString(e.getStackTrace()));
                }
            }
        }
        return FinalLine;
